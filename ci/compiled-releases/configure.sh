...
fly -t env0 check-resource -r compile-releases/concourse-release -f version:1
fly -t env0 check-resource -r compile-releases/credhub-release -f version:1
fly -t env0 check-resource -r compile-releases/uaa-release -f version:1
fly -t env0 check-resource -r compile-releases/garden-runc-release -f version:1
fly -t env0 check-resource -r compile-releases/bbr-sdk-release -f version:1
